...
def main():
    ...
    """model save"""
    torch.save(model.state_dict(), './assets/model_v5.pth')
    artifact = wandb.Artifact('model_v5', 
                              type='model',
                              metadata=config) # description=""
    artifact.add_file('./assets/model_v5.pth')
    wandb.log_artifact(artifact)
    
    # """model load"""
    # artifact = wandb.use_artifact('anseunghwan/(causal)VAE/model_v5:v{}'.format(0), type='model')
    # artifact.metadata
